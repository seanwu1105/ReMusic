...
public class PatternButtonStyle extends BasicButtonUI
{
	@Override
	...
	public void paint(Graphics g, JComponent c)
	{
		...
		else if (b.getModel().isSelected()) // JToggleButton
	...
	private void paintBackground(Graphics g, JComponent c, int styleNumber)
	{
		...
		g.fillRoundRect(borderThickness, borderThickness, size.width - borderThickness * 2,
				size.height - borderThickness * 2, 7, 7);
	}
}
