...
public class SettingButtonStyle extends BasicButtonUI
{
	@Override
	...
	private void paintBackground(Graphics g, JComponent c, int styleNumber)
	{
		...
		int xInner[] = { borderThickness, borderThickness * 5, size.width - borderThickness,
				size.width - borderThickness, size.width - 5 * borderThickness, borderThickness };
