...
public class GamingButtonStyle extends BasicButtonUI
{
	@Override
	...
	public void paint(Graphics g, JComponent c)
	{
		...
		Main.gamingPanel.showStatus(c, buttonEventStyleNum);
		Main.settingPanel.showStatus(c, buttonEventStyleNum);
	...
	private void paintBackground(Graphics g, JComponent c, int styleNumber)
	{
		...
		else if (styleNumber == 3) // Button disabled
		{
			g.setColor(c.getBackground().darker());
			g.fillRect(0, 0, size.width, size.height);
		...
		g.fillRect(borderThickness, borderThickness, size.width - borderThickness * 2,
				size.height - borderThickness * 2);
	}
}
